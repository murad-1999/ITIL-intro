...
const ZoomControls = () => {
  ...
  return (
    <div className="absolute bottom-4 right-4 md:bottom-6 md:right-[230px] z-40 flex items-center gap-2 md:gap-3 bg-white/90 dark:bg-zinc-950/90 border border-slate-350 dark:border-zinc-800 p-1.5 md:p-2.5 rounded-xl shadow-2xl backdrop-blur-md pointer-events-auto select-none transition-colors">
      {/* Zoom Level Indicator */}
      <span className="text-[9px] md:text-[10px] font-mono text-slate-500 dark:text-zinc-400 min-w-[28px] md:min-w-[32px] text-right">
      ...
      <button
        ...
        className="p-1 md:p-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 border border-slate-300 dark:border-zinc-800 rounded-lg text-slate-700 hover:text-slate-900 dark:text-zinc-300 dark:hover:text-white transition-all flex items-center justify-center shadow-sm"
        title="Zoom Out"
      >
      ...
      <button
        ...
        className="p-1 md:p-1.5 px-2 md:px-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-zinc-900 dark:hover:bg-zinc-800 border border-slate-300 dark:border-zinc-800 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg text-slate-700 dark:text-zinc-300 transition-all flex items-center gap-1 md:gap-1.5 text-[10px] md:text-[11px] font-medium shadow-sm"
  ...
  return (
    ...
    >
      ...
      <MiniMap 
        ...
        className="hidden md:block bg-white dark:bg-zinc-950 border border-slate-300 dark:border-zinc-800 rounded-xl transition-colors"
        pannable
        zoomable
      />
      <ZoomControls />
