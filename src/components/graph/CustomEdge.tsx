      ...
      {label && (
        <EdgeLabelRenderer>
          ...
          >
            <span
              className={clsx(
                "px-2.5 py-1 rounded-md text-[10px] font-semibold tracking-tight shadow-md border backdrop-blur-md transition-colors select-none inline-block whitespace-nowrap",
                isFeedback
